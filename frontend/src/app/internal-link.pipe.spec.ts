...
const SIMPLE_HTML_OUTPUT = "<p>Note 2: <code>merchantUrl</code> parameter must be encoded using <a routerLink=\"['app', 'documentation', 'navigation', 'HierarchyNode', path=theGardener>master>_features_/administration]\">URL encoding</a>.</p>"
...
const SIMPLE_HTML_OUTPUT_WITH_HIERARCHY = "<p>Note 2: <code>merchantUrl</code> parameter must be encoded using <a routerLink=\"['app', 'documentation', 'navigation', '_publisher', path=publisherSystems>master>_Public_/publisherServices]\">URL encoding</a>.</p>"
...
const COMPLEX_HTML_OUTPUT = "<p>Note 2: <code>merchantUrl <a routerLink=\"['app', 'documentation', 'navigation', 'HierarchyNode', path=theGardener>master>_features_/administration]\">internal link1</a> </code> parameter must be encoded using <a routerLink=\"['app', 'documentation', 'navigation', '_publisher', path=publisherSystems>master>_Public_/publisherServices]\">internal link2</a>.</p>"
