...
export class RouteService {
  ...
  directoryPathSimilar(currentNavigationRoute: NavigationRoute, menuItemNavigationRoute: NavigationRoute) {
    ...
    return (
      currentFontEndPath.nodesPath === menuItemFontEndPath.nodesPath &&
  ...
  pagePathSimilar(currentNavigationRoute: NavigationRoute, menuItemNavigationRoute: NavigationRoute) {
    return (
      currentNavigationRoute.nodes?.join(EMPTY_CHAR) === menuItemNavigationRoute.nodes?.join(EMPTY_CHAR) &&
      currentNavigationRoute.project === menuItemNavigationRoute.project &&
  ...
  backEndHierarchyAndPathToFrontEndPath(hierarchy: string, path: string) {
    ...
    return (
      hierarchyFrontEndPath + '/' + navigationRoute.project + '/' + navigationRoute.branch + '/' + directories + '/' + navigationRoute.page
    );
  }
