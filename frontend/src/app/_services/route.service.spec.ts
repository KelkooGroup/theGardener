...
describe('RouteService', () => {
  ...
  it('navigationParamsToNavigationRoute focus on nodes', () => {
    ...
    expect(service.navigationParamsToNavigationRoute({ nodes: '_publisher_systems_services' }).nodes).toEqual([
      'publisher',
      'systems',
      'services'
    ]);
  ...
  it('navigationParamsToNavigationRoute focus on directories', () => {
    ...
    expect(service.navigationParamsToNavigationRoute({ directories: '_Features_Categories' }).directories).toEqual([
      'Features',
      'Categories'
    ]);
    expect(service.navigationParamsToNavigationRoute({ directories: '__Features_Categories' }).directories).toEqual([
      'Features',
      'Categories'
    ]);
  });
  ...
  it('navigationRouteToFrontendPath ', () => {
    ...
    expect(service.navigationRouteToFrontEndPath(navigationRoute).pathFromNodes).toEqual(
      '_publisher_systems_services/ecs/_/_Features_Categories/Model'
    );
  ...
  it('navigationRouteToFrontendPath focus on branch', () => {
    expect(service.navigationRouteToFrontEndPath({ branch: 'feature/153_categories' }).pathFromNodes).toEqual(
      '/_/feature_153.categories/_'
    );
  });
  ...
  it('navigationParamsToFrontEndPath ', () => {
    ...
    expect(service.navigationParamsToFrontEndPath(navigationParams).pathFromNodes).toEqual(
      '_publisher_systems_services/ecs/_/_Features_Categories/Model'
    );
  });

  it('backEndPathToNavigationRoute focus on directory', () => {
    expect(service.backEndPathToNavigationRoute('publisherSystems>>/')).toEqual({
      project: 'publisherSystems',
      branch: '_',
      directories: [],
      page: undefined
    });
    expect(service.backEndPathToNavigationRoute('publisherData>>/Public/')).toEqual({
      project: 'publisherData',
      branch: '_',
      directories: ['Public'],
      page: undefined
    });
  ...
  it('backEndHierarchyAndPathToFrontEndPath ', () => {
    expect(
      service.backEndHierarchyAndPathToFrontEndPath('/platform/publisher/systems/mgt', 'pmws>qa>/Features/Events/Constraints')
    ).toEqual('_platform_publisher_systems_mgt/pmws/qa/_Features_Events/Constraints');
    expect(service.backEndHierarchyAndPathToFrontEndPath('/platform/publisher/systems/mgt', 'pmbo>qa>/Meta')).toEqual(
      '_platform_publisher_systems_mgt/pmbo/qa/_/Meta'
    );
  });
  ...
  it('legacyFullFrontEndUrlToFullFrontEndUrl ', () => {
    expect(
      RouteService.legacyFullFrontEndUrlToFullFrontEndUrl(
        'app/documentation/navigate/_publisher;path=shoppingApiPublic%3E%3E_Features_Feeds_/Feature'
      )
    ).toEqual('app/documentation/navigate/_publisher/shoppingApiPublic/_/_Features_Feeds/Feature');
    expect(
      RouteService.legacyFullFrontEndUrlToFullFrontEndUrl(
        'app/documentation/navigate/_publisher;path=shoppingApiPublic>>_Features_Feeds_/Feature'
      )
    ).toEqual('app/documentation/navigate/_publisher/shoppingApiPublic/_/_Features_Feeds/Feature');
    expect(
      RouteService.legacyFullFrontEndUrlToFullFrontEndUrl(
        'app/documentation/navigate/_publisher;path=shoppingApiPublic>qa>_Features_Feeds_/Feature'
      )
    ).toEqual('app/documentation/navigate/_publisher/shoppingApiPublic/qa/_Features_Feeds/Feature');
    expect(
      RouteService.legacyFullFrontEndUrlToFullFrontEndUrl('app/documentation/navigate/_publisher;path=shoppingApiPublic>qa>_/Feature')
    ).toEqual('app/documentation/navigate/_publisher/shoppingApiPublic/qa/_/Feature');
    expect(
      RouteService.legacyFullFrontEndUrlToFullFrontEndUrl('app/documentation/navigate/_publisher;path=shoppingApiPublic%3Eqa%3E_/Feature')
    ).toEqual('app/documentation/navigate/_publisher/shoppingApiPublic/qa/_/Feature');
  });

  it('legacyFullFrontEndUrlToFullFrontEndUrl do not touch current pattern', () => {
    expect(
      RouteService.legacyFullFrontEndUrlToFullFrontEndUrl('app/documentation/navigate/_publisher/publisherSystems/_/_/Services')
    ).toEqual('app/documentation/navigate/_publisher/publisherSystems/_/_/Services');
  });

  it('relativeUrlToFullFrontEndUrl ', () => {
    expect(
      service.relativeUrlToFullFrontEndUrl('Public/Features/OfferFeeds/Feature', {
        nodes: '_publisher_systems_services_shopping',
        project: 'shoppingAPI',
        branch: 'qa',
        directories: '_',
        page: 'Why'
    ...
    expect(
      service.relativeUrlToFullFrontEndUrl('../../Guides/Feeds/UseCases', {
        nodes: '_publisher_systems_services_shopping',
        project: 'shoppingAPI',
        branch: 'qa',
        directories: '_Public_Features_OfferFeeds',
        page: 'Feature'
      })
    ).toEqual('app/documentation/navigate/_publisher_systems_services_shopping/shoppingAPI/qa/_Public_Guides_Feeds/UseCases');
    expect(
      service.relativeUrlToFullFrontEndUrl('../OfferSearch/Feature', {
        nodes: '_platform_publisher_systems_public',
        project: 'shoppingAPIPublic',
        branch: 'feature_PUB-4629-review-doc',
        directories: '_Features_OfferFeeds',
        page: 'Feature'
      })
    ).toEqual(
      'app/documentation/navigate/_platform_publisher_systems_public/shoppingAPIPublic/feature_PUB-4629-review-doc/_Features_OfferSearch/Feature'
    );
    expect(
      service.relativeUrlToFullFrontEndUrl('https://thegardener.kelkoogroup.com', {
        nodes: 'Tools',
        project: 'theGardener',
        branch: 'master',
        directories: '_Guide_Write',
        page: 'Basics'
      })
    ).toEqual('https://thegardener.kelkoogroup.com');
    expect(
      service.relativeUrlToFullFrontEndUrl('OpenApi', {
        nodes: 'Tools',
        project: 'theGardener',
        branch: 'master',
        directories: '_Guide_Write',
    ...
    expect(
      service.relativeUrlToFullFrontEndUrl('../Guides', {
        nodes: 'Tools',
        project: 'theGardener',
        branch: 'master',
        directories: '_Guide_Write',
    ...
    expect(
      service.relativeUrlToFullFrontEndUrl('../../Changelog', {
        nodes: 'Tools',
        project: 'theGardener',
        branch: 'master',
        directories: '_Guide_Write',
    ...
    expect(
      service.relativeUrlToFullFrontEndUrl('../../Features/Projects/Model', {
        nodes: 'Tools',
        project: 'theGardener',
        branch: 'master',
        directories: '_Guide_Write',
  ...
  it('directoryPathSimilar ', () => {
    ...
    expect(
      service.directoryPathSimilar(navigationRoute, {
        nodes: ['publisher'],
        project: 'ecs',
        branch: '_',
  ...
  it('pagePathSimilar ', () => {
    ...
    expect(
      service.pagePathSimilar(navigationRoute, {
        nodes: ['publisher'],
        project: 'ecs',
        branch: '_',
        directories: [] as Array<string>,
  ...
  it('extractKeyword ', () => {
    expect(
      service.extractKeyword({
        nodes: ['publisher', 'services', 'shopping'],
        project: 'shoppingAPI',
        branch: '_',
        directories: ['Public', 'Guides'],
        page: 'AuthenticationWithSignedUrlGuide'
      })
