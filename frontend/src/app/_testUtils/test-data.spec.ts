  ...
  content: [
    {
      ...
      data: {
        markdown:
          "For various reasons, the offers provided to the publishers can be filtered. We don't necessary want to provide all the\n" +
  ...
  content: [
    {
      ...
      data: {
        markdown:
          '**Markdown containing escaped Markdown\n' +
          '````\n' +
          '```thegardener\n' +
          '{\n' +
          '  "page" :\n' +
