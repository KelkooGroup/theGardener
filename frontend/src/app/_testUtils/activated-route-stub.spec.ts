 ...
 */
@Injectable()
/* eslint-disable @typescript-eslint/naming-convention, no-underscore-dangle, id-blacklist, id-match, @typescript-eslint/member-ordering, @typescript-eslint/ban-types */
