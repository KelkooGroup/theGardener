...
"""
  ...
  Scenario: get result of a search with pages only attached to the hierarchy by the node.directoryPath
    Given we have those directories in the database
      ...
      | 2  | suggestions | Suggestions   | Suggestions...                     | 0     | /suggestions/ | suggestionsWS>master>/suggestions/ | 1        |
      | 3  | admin       | Admin         | Administration...                  | 1     | /admin/       | suggestionsWS>master>/admin/       | 1        |
      | 4  | libraryDoc  | libraryDoc    | library system group documentation | 0     | /             | libraryDoc>master>/                | 3        |
    And we have those pages in the database
      | id | name           | label            | description                    | order | relativePath            | path                                         | markdown                              | directoryId |
      | 1  | context        | The context      | Why providing suggestions      | 0     | /context                | suggestionsWS>master>/context                | **Feature**: Provide book suggestions | 1           |
      | 2  | suggestion     | The suggestions  | The suggestions...             | 0     | /suggestions/suggestion | suggestionsWS>master>/suggestions/suggestion | **What's a suggestion ?**             | 2           |
      | 3  | examples       | examples         | Some examples                  | 1     | /suggestions/examples   | suggestionsWS>master>/suggestions/examples   | **Some suggestion examples**          | 2           |
      | 4  | admin          | admin            | admin                          | 0     | /admin/admin            | suggestionsWS>master>/admin/admin            | **Page for the admin users**          | 3           |
      | 5  | libDocOverview | Overview library | Overview library documentation | 0     | /overview               | libraryDoc>master>/overview                  | **Documentation on the library**      | 4           |
    And the lucene index is loaded from the database
    And I perform a "GET" on following URL "/api/pages/search?keyword=library"
    Then I get a response with status "200"
    Then I get the following json response body
    """
{
  "items": [
    {
      "page": {
        "id": "/lib/libraryDoc>master>/overview",
        "hierarchy": "/lib",
        "path": "libraryDoc>master>/overview",
        "breadcrumb": "Library / library  system group documentation / Overview library",
        "project": "library  system group documentation",
        "branch": "master",
        "label": "Overview library",
        "description": "Overview library documentation",
        "pageContent": "**Documentation on the library**"
      },
      "highlights": [
        {
          "fragment": "<em>Library</em> / <em>library</em>  system group documentation / Overview <em>library</em>",
          "word": "Library"
        },
        {
          "fragment": "Overview <em>library</em>",
          "word": "library"
        },
        {
          "fragment": "Overview <em>library</em> documentation",
          "word": "library"
        },
        {
          "fragment": "**Documentation on the <em>library</em>**",
          "word": "library"
        }
      ]
    }
