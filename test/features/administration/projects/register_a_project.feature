        ...
        """
{
	...
	"sourceUrlTemplate": "http://gitlab.corp.kelkoo.net:library/suggestionsWS/blob/${branch}/${path}",
	"stableBranch": "master",
       ...
       """
{
    ...
    "documentationRootPath": "documentation"
     ...
     """
    Then the projects settings are now
      | id            | name                    | repositoryUrl                                        | sourceUrlTemplate                                                          | stableBranch | displayedBranches | featuresRootPath | documentationRootPath |
      | suggestionsWS | Suggestions WebServices | git@gitlab.corp.kelkoo.net:library/suggestionsWS.git | http://gitlab.corp.kelkoo.net:library/suggestionsWS/blob/${branch}/${path} | master       | master            | test/features    | documentation         |


  @level_2_technical_details @nominal_case @valid @register_project
  Scenario: setup a project - without optional fields
    Given no project settings are setup in theGardener
    When I perform a "POST" on following URL "/api/projects" with json body
        """
{
       ...
       """
{
  ...
  Scenario: get a project
    Given we have the following projects
      | id            | name                    | repositoryUrl                                        | sourceUrlTemplate                                                          | stableBranch | featuresRootPath |
      | suggestionsWS | Suggestions WebServices | git@gitlab.corp.kelkoo.net:library/suggestionsWS.git | http://gitlab.corp.kelkoo.net:library/suggestionsWS/blob/${branch}/${path} | master       | test/features    |
       ...
       """
{
  ...
  @level_2_technical_details @nominal_case @valid
  Scenario: update a project - add optional fields
    Given we have the following projects
      | id            | name                    | repositoryUrl                                        | sourceUrlTemplate | stableBranch | featuresRootPath |
      | suggestionsWS | Suggestions WebServices | git@gitlab.corp.kelkoo.net:library/suggestionsWS.git |                   | master       | test/features    |
    When I perform a "PUT" on following URL "/api/projects/suggestionsWS" with json body
       ...
       """
{
  ...
  """
    And the projects settings are now
      | id            | name                     | repositoryUrl                                        | sourceUrlTemplate                                                          | stableBranch | featuresRootPath |
      | suggestionsWS | Suggestions WebServices1 | git@gitlab.corp.kelkoo.net:library/suggestionsWS.git | http://gitlab.corp.kelkoo.net:library/suggestionsWS/blob/${branch}/${path} | master       | test/features    |
