...
class ConfluenceClientTest extends PlaySpec {
  ...
  "ConfluenceClientTest" should {
    ...
    "parse page content" in {
      assert(ConfluenceClient.parsePage(ConfluenceClientTest.pageWithMarkdown).title.equals("TEST REST API WITH MD"))
    }
