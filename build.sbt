...
libraryDependencies ++= Seq(
  ...
  jdbc,
  caffeine,
  "ch.qos.logback" % "logback-access" % "1.4.0",
  ...
  // Swagger
  "io.swagger" % "swagger-annotations" % "1.6.6", // do not upgrade beyond 1.x because of sbt-swagger-play compatibility
  ...
  // Cucumber
  "io.cucumber" %% "cucumber-scala" % "8.8.0" % Test,
